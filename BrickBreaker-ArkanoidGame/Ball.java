...
public class Ball implements Sprite {
    ...
    public void moveOneStep() {
        double endX = (this.getX() + this.getVelocity().getDx());
        double endY = (this.getY() + this.getVelocity().getDy());
        //trajectory- line from the current position of center to the next step of it.
        //Line trajectory = new Line(Math.floor(this.getX()), Math.floor(this.getY()), Math.floor(endX), Math.floor(endY));
        ...
        if (closestCollision == null) {
            ...
            Velocity newVelocity = closestCollision.collisionObject().hit(collisionPoint, this.velocity);
            // update velocity.
